	...
	<div class="overflow-hidden">
		...
		<section id="ms-banner-section" class="ms-contact-bnr">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 class="text-white ms-font-weight-900">重置密碼</h1>
						<div class="ms-seperator my-4"></div>
						<h5 class="pt-1 font-weight-normal text-white">
							<a class="text-white" href="/MOBEVA/">首頁</a> / 重置密碼
						</h5>
					</div>
				</div>
			</div>
				...
				<div align="center">
					<form method="POST" action="updatepassword">
						<table style="margin: auto; border: 1px;">
							<tr>
								<td><h3>請輸入舊密碼:</h3></td>
								<td><h3><input type="password" name="password" required></h3></td>
							</tr>
							<tr>
								<td><h3>請輸入新密碼:</h3></td>
								<td><h3><input type="password" name="newpassword1" required></h3></td>
							</tr>
							<tr>
								<td><h3>請再次輸入新密碼:</h3></td>
								<td><h3><input type="password" name="newpassword2" required></h3></td>
							</tr>
							<tr>
								<td colspan="2" style="text-align: center"><input
									type="submit"
									class="btn ms-primary-btn ms-red-border-btn ms-font-oswald"
									value="重設密碼" style="padding: 5px 20px; margin-top: 10px;"></td>
							</tr>
						</table>
					</form>
				</div>
