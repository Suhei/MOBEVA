  ...
  <body>
      ...
      <div id="dialog" style="background-color: white;padding: 10px;">
          <div style="display:inline-block;vertical-align:top;width: 220px;">
              <h4>Sign in</h4>
              <form>
                  <input id="username" type="text" placeholder="Email 會員帳號" name="account"><br>
                  <input id="password" type="password" placeholder="Password 會員密碼" name="password"><br>
                  <a href="#." style="font-size: 13px;"><b>忘記密碼</b></a><br>
                  <input type="submit" class="btn ms-primary-btn ms-red-border-btn ms-font-oswald" value="登入"
                      style="padding: 5px 20px;margin-top: 15px;">
              </form>
          </div>
          <div style="display:inline-block;border-left: solid 1px #cccccc;margin: 5px;height: 155px;"></div>
          <div style="display:inline-block;width: 220px;vertical-align:top;margin-left: 20px;">
              <form>
                  <h4>Register</h4>
                  <input id="registerusername" type="text" placeholder="Email 會員帳號" name="registeraccount"><br>
                  <input id="registerpassword" type="password" placeholder="Password 會員密碼" name="registerpassword"><br>
                  <input id="checkpassword" type="password" placeholder="Password 再次輸入密碼" name="checkpassword"><br>
                  <input type="submit" class="btn ms-primary-btn ms-red-border-btn ms-font-oswald" value="註冊"
                      style="padding: 5px 20px;margin-top: 10px;">
                  <input type="reset" class="btn ms-primary-btn ms-red-border-btn ms-font-oswald" value="重填"
                      style="padding: 5px 20px;margin-top: 10px;">
              </form>
          </div>
      </div>
      ...
      <div class="overflow-hidden">
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-md-4 col-lg-3">
                          <a class="navbar-brand ms-logo-pad" href="index.html"><img src="images/Logo.png"
                              ...
                              <div class="ms-header-top">
                                  <div class="d-inline float-right">
                                      ...
                                      <!-- <a href="#."><img src="images/User_icon.png" class="img-fluid mx-1 mx-md-2"
                                              alt="User Icon"></a> -->
                                      <a href="<c:url value='/login'/>"><img src="images/user01.png" class="img-fluid mx-1 mx-md-2" 
                                          alt="User Icon" style="cursor: pointer;"></a>
                                      <a href="cart.html"><img src="images/shopping-cart01.png" class="img-fluid mx-1 mx-md-2"
                                              alt="Shop Icon"></a>
                                  </div>
                                  <div class="text-white d-inline">
                                      <p class="d-inline-block mb-auto ms-font-oswald text-white"> </p>
                                  </div>
                              </div>
                                  ...
                                  <nav class="navbar navbar-expand-lg ms-header-area">
                                      ...
                                      <div class="collapse navbar-collapse ms-header-content"
                                          ...
                                          <ul class="navbar-nav">
                                              ...
                                              <li class="dropdown nav-item">
                                                  <a class="nav-link ms-font-oswald ms-font-17 text-white"
                                                       href="${ctx}/profile" role="button" aria-haspopup="true"
                                                      aria-expanded="false">會員資料</a>
                                              </li>
                                              <li class="dropdown nav-item">
                                                  <a class="nav-link ms-font-oswald ms-font-17 text-white"
                                                      href="${ctx}/shop" role="button"
                                                      aria-haspopup="true" aria-expanded="false">購物專區</a>
                                                  <!-- <div class="dropdown-menu">
                                                      <a class="dropdown-item ms-font-oswald ms-font-17"
                ...
                <div id="homeslider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/banners/slider-3.jpg" class="img-fluid ms-slide-img" alt="Slider Image">
                                ...
                                <div class="col-md-12 ms-slider-pad">
                                    ...
                                    <div class="row">
                                        <div class="offset-md-1 offset-xl-2 col-md-5 col-xl-4">
                                            <a href="contact.html" class="btn ms-primary-btn ms-font-oswald">聯絡我們</a>
                                        </div>
                                            ...
                                            <div class="card mb-3 bg-transparent border-0">
                                                <div class="row no-gutters align-items-center position-relative">
                                                    ...
                                                    <div class="col-6 col-md-9">
                                                        <h5 class="ms-font-oswald font-weight-normal text-left ml-2">
                                                            PLAY OUR<br> PROMO VIDEO</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="carousel-item">
                            <img src="images/banners/team-banner.jpg" class="img-fluid ms-slide-img" alt="Slider Image">
                            <div class="carousel-caption">
                                <div class="col-md-12 ms-slider-pad">
                                    <h1 class="ms-font-weight-900 pb-3">優質的車輛保修服務</h1>
                                    <div class="ms-spacer-60"></div>
                        ...
                        <div class="carousel-item">
                            <img src="images/banners/faq-banner.jpg" class="img-fluid ms-slide-img" alt="Slider Image">
                            <div class="carousel-caption">
                                <div class="col-md-12 ms-slider-pad">
                                    <h1 class="ms-font-weight-900 pb-3">優質的車輛保修服務</h1>
                                    <div class="ms-spacer-60"></div>
        ...
        <section id="ms-service-section">
            <img class="img-fluid position-absolute ms-sidebar-img" src="images/Sidebar-Full.jpg" alt="Sidebar Image">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 ms-left-image-bg">
                        <div class=" text-white">
                            ...
                            <ul class="list-group">
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期一</span>10.00
                                        - 20.00</p>
                                </li>
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期二</span>10.00
                                        - 20.00</p>
                                </li>
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期三</span>10.00
                                        - 20.00</p>
                                </li>
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期四</span>10.00
                                        - 20.00</p>
                                </li>
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期五</span>10.00
                                        - 20.00</p>
                                </li>
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期六</span>10.00
                                        - 20.00</p>
                                </li>
                                <li>
                                    <p class="font-weight-light text-white"><span class="d-inline-block">星期日</span>休息日
                                    </p>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6 col-md-6 pr-2 pr-md-3">
                                    <div class="ms-service-box rounded text-center position-relative">
                                        <img class="img-fluid pb-3 ms-main-img" src="images/24.png" alt="Service Image">
                                        <p class="ms-font-lato font-weight-bold">車輛檢查</p>
                                        <div class="ms-service-box-hover position-absolute rounded">
                                            <img class="img-fluid pb-3" src="images/25.png" alt="Service Hover Image">
                                ...
                                <div class="col-6 col-md-6 pl-2 pl-md-3">
                                    <div class="ms-service-box rounded text-center position-relative">
                                        <img class="img-fluid pb-3 ms-main-img" src="images/23.png" alt="Service Image">
                                        <p class="ms-font-lato font-weight-bold">預約保養</p>
                                        <div class="ms-service-box-hover position-absolute rounded">
                                            <img class="img-fluid pb-3" src="images/26.png" alt="Service Hover Image">
                                ...
                                <div class="col-6 col-md-6 pl-2 pl-md-3">
                                    <div class="ms-service-box rounded text-center position-relative mb-0">
                                        <img class="img-fluid pb-3 ms-main-img" src="images/21.png" alt="Service Image">
                                        <p class="ms-font-lato font-weight-bold">維修</p>
                                        <div class="ms-service-box-hover position-absolute rounded">
                                            <img class="img-fluid pb-3" src="images/28.png" alt="Service Hover Image">
            ...
            <div class="container">
                <div class="row text-white">
                    <div class="col-md-6 col-lg-7">
                        ...
                        <a href="contact.html" class="btn ms-primary-btn ms-font-oswald mt-2">聯絡我們</a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="ms-contact-box rounded ms-bg-red text-center">
                                    ...
                                    <p class="ms-font-17 ms-font-lato ms-font-weight-900 mt-3 mb-1 text-white">地址</p>
                                ...
                                <div class="ms-contact-box rounded ms-bg-orange text-center">
                                    ...
                                    <p class="ms-font-17 ms-font-lato ms-font-weight-900 mt-3 mb-1 text-white">EMAIL</p>
                                    <a href="mailto:info@car.com">
                                        <h6 class="font-weight-light ms-font-roboto-slab mb-0">info@car.com</h6>
                                    </a>
                                    <a href="mailto:job@car.com">
                                        <h6 class="font-weight-light ms-font-roboto-slab mb-0">job@car.com</h6>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="ms-contact-box rounded ms-bg-blue text-center position-relative">
                                    <img src="images/Phone_icon.png" alt="Phone Icon">
                                    <p class="ms-font-17 ms-font-lato ms-font-weight-900 mt-3 mb-1 text-white">電話</p>
                                    <a href="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div class="ms-team-box text-center rounded position-relative">
                            <img class="img-fluid ms-team-img" src="images/boy1.png" alt="Team Image">
                            <img class="img-fluid position-absolute" src="images/Team-icon.png" alt="Team Icon">
                            <p class="ms-font-21 ms-font-lato font-weight-bold mt-4 mb-0 ms-font-111">柏憲</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 pb-5 pb-lg-0">
                        <div class="ms-shop-box text-center rounded">
                            ...
                            <p class="ms-font-21 ms-font-lato font-weight-bold mb-0 ms-font-111">Flat Tyres</p>
                    ...
                    <div class="col-md-6 col-lg-3 pb-5 pb-lg-0">
                        <div class="ms-shop-box text-center rounded">
                            ...
                            <p class="ms-font-21 ms-font-lato font-weight-bold mb-0 ms-font-111">Car Oil Filter</p>
                            <h6 class="ms-font-4a4a4a ms-font-roboto-slab mb-4">dolor silok consectet</h6>
                    ...
                    <div class="col-md-6 col-lg-3 pb-5 pb-md-0">
                        <div class="ms-shop-box text-center rounded">
                            ...
                            <p class="ms-font-21 ms-font-lato font-weight-bold mb-0 ms-font-111">Fuel Injection</p>
                            <h6 class="ms-font-4a4a4a ms-font-roboto-slab mb-4">dolor silok consectet</h6>
                            <h3 class="d-inline ms-font-oswald"><del>$150</del></h3>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="ms-shop-box text-center rounded">
                            ...
                            <p class="ms-font-21 ms-font-lato font-weight-bold mb-0 text-dark">Red Car Bumper</p>
                            <h6 class="ms-font-4a4a4a ms-font-roboto-slab mb-4">dolor silok consectet</h6>
                            <h3 class="d-inline ms-font-oswald"><del>$80</del></h3>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 pb-4 pb-md-0">
                            ...
                            <h6 class="ms-font-roboto-slab font-weight-light"><a href="service_detail.html">發動機維修</a>
                            </h6>
                            <h6 class="ms-font-roboto-slab font-weight-light"><a href="service_detail.html">動力轉向</a>
                            </h6>
                            <h6 class="ms-font-roboto-slab font-weight-light"><a href="service_detail.html">更換耗材</a>
                            </h6>
                            <h6 class="ms-font-roboto-slab font-weight-light"><a href="service_detail.html">排氣檢查</a>
                            </h6>
                            <h6 class="ms-font-roboto-slab font-weight-light"><a href="service_detail.html">輪胎檢查</a>
                            </h6>
                            <h6 class="ms-font-roboto-slab font-weight-light"><a href="service_detail.html">車隊服務</a>
                            </h6>
                        </div>
                        <div class="col-md-3 pb-4 pb-md-0">
                            <h5 class="text-white ms-font-21 font-weight-bold mb-4">營業時間</h5>
                            <h6 class="ms-font-roboto-slab font-weight-light mb-4">週一到週六:<br> 早上10點 至 晚上8點</h6>
                            <h6 class="ms-font-roboto-slab font-weight-light">休假日:<br> 每週日<br> 跟法定假日</h6>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            ...
                            <h6 class="ms-font-roboto-slab font-weight-light position-relative">&copy; Copyright 2019.
                                Mobeva automobiles limited</h6>
                        </div>
                        <div class="col-md-2 text-md-center my-4 my-md-0">
                            <a class="mr-2 mr-lg-3" href="" target="_blank"><i class="fab fa-facebook-f fa-2x"></i></a>
                            <a class="mr-2 mr-lg-3" href="" target="_blank"><i class="fab fa-twitter fa-2x"></i></a>
                            <a href="" target="_blank"><i class="fab fa-linkedin-in fa-2x"></i></a>
                        </div>
                        <div class="offset-md-1 col-md-5">
                            <div class="ms-bg-orange text-white">
                                <h5 class="ms-font-weight-900">聯絡方式</h5>
                                <h5 class="ms-font-roboto-slab font-weight-light mb-0">電話: <span><a href=""
                                            class="text-white">(02)66318168</a></span></h5>
                                <h5 class="ms-font-roboto-slab font-weight-light mb-1">Email: <span><a
                                            href="mailto:info@website.com"
                                            class="text-white">info@website.com</a></span></h5>
    ...
    <div class="modal fade" id="msvideobox" tabindex="-1" role="dialog" aria-labelledby="msvideobox" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                <iframe width="720" height="405" src="https://www.youtube.com/embed/9X_uPjJW9mY?controls=0"
