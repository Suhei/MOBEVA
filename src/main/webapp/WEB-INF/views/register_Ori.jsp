				...
				<div class="row">
					<div class="col-md-12">
						...
						<h5 class="pt-1 font-weight-normal text-white">
							<a class="text-white" href="index.html">首頁</a> / 購物車
						</h5>
					</div>
				</div>
			</div>
		...
		<div style="width: 20%; margin: auto;">
			...
			<form:form method="POST" modelAttribute="UserInfoBean"
				...
				<table style="margin: auto;">
					<tr>
						<td>帳號:</td>
						<td><form:input path='u_account' /></td>
					</tr>
					<tr>
						<td>密碼:</td>
					...
					<tr>
						<td>身份證字號:</td>
						<td><form:input path='u_idcard' /></td>
					</tr>
					<tr>
						<td>信箱:</td>
						<td><form:input path='u_email' /></td>
					</tr>
					<tr>
						<td>電話:</td>
						<td><form:input path='u_mobile' /></td>
					</tr>
					<tr>
						<td>地址:</td>
						<td><form:input path='u_address' /></td>
					</tr>
					<tr>
							...
							<div class="ms-bg-orange text-white">
								...
								<h5 class="ms-font-roboto-slab font-weight-light mb-1">
									Email: <span><a href="mailto:info@website.com"
										class="text-white">info@website.com </內文></span>
								</h5>
