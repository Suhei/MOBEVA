                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('新增使用者','./role-add.html',600,400)"><i class="layui-icon"></i>新增</button>
                        </div>
                        <div class="layui-card-body ">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    ...
                                    <a title="編輯"  onclick="xadmin.open('編輯','role-add.html')" href="javascript:;">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
