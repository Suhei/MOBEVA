...
<body>
	<div class="layui-fluid">
		<div class="layui-row">
			<form:form class="layui-form" modelAttribute="ProductBean"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline" id="pcategory">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<form:textarea rows="10" cols="50" id="spdesc" path="sp_desc"
							required="" lay-verify="email" autocomplete="off" />
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<form:input type="file" name="uploadImg1"
							path="uploadImg1" class="layui-input" />
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<form:input type="file" name="uploadImg2"
							path="uploadImg2" class="layui-input" />
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<form:input type="file" name="uploadImg3"
							path="uploadImg3" class="layui-input" />
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<form:input type="file" name="uploadintro"
							path="uploadintro" class="layui-input" />
					</div>
				</div>
				...
				<div class="layui-form-item">
					<label for="L_repass" class="layui-form-label"> </label> <input
						type="submit" value="新增商品" class="layui-btn">
				</div>
			</form:form>
				<button onclick="allinput()">一鍵輸入</button>
		</div>
	</div>
	<script>
		...
		function allinput() {
			document.getElementById("productName").value = "無線充電車用支架"
			document.getElementById("productPrice").value = "999"
			document.getElementById("productStock").value = "20"
			document.getElementById("spdesc").value = "<li>有線無線都能充</li><li>360度旋轉，隨意調節角度</li><li>適用55-89mm的智慧型手機</li>"
		}
