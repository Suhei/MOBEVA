  ...
  <body>
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-header">
                        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量恢復</button>
                    </div>
                    <div class="layui-card-body ">
                        <table class="layui-table layui-form">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="td-manage">
                                <a title="恢復" onclick="member_del(this,'要刪除的id')" href="javascript:;">
    ...
    <script>
      ...
      function delAll (argument) {
        ...
        layer.confirm('確認要恢復嗎？'+data,function(index){
            //捉到所有被選中的，發非同步進行刪除
            layer.msg('恢復成功', {icon: 1});
