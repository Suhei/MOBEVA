				...
				<div class="layui-card">
					...
					<div class="layui-card-body ">
						<table class="layui-table layui-form">
							<button>
								<a href="<spring:url value='/admin/b_mp_add'/>">新增</a>
							</button>
							<thead>
								<tr>
									<th>零件編號</th>
							...
							<tbody>
								<c:forEach var='m_part' items='${m_parts}'>
									<form:form method="POST" modelAttribute="New_Mp_Form">
										<tr>
											<td><form:input type='text' path='mp_id' readonly="true"
													value="${m_part.mp_id}" /></td>
											<td><form:input type='text' path="mp_name"
													value="${m_part.mp_name}" /></td>
											<td><form:input type='text' path="mp_price"
													value="${m_part.mp_price}" /></td>
											<td><form:input type='text' path='mp_stock'
													value="${m_part.mp_stock}" /></td>
											<td><form:input type='text' path='mp_createdate'
													value="${m_part.mp_createdate}" /></td>
											<td><form:input type='text' path='mp_modifieddate'
													value="${m_part.mp_modifieddate}" /></td>
											<td><form:input type='text' path='mp_status'
													value="${m_part.mp_status}" /></td>
