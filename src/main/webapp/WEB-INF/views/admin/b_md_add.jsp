			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-body ">
						...
						<form:form method="POST" modelAttribute="New_Md_Form"
							id="showId-1" servletRelativeAction="/admin/b_md_add">
							<div class="form-row">
								<p
									class="ms-font-lato ms-font-weight-900 text-center text-black">承攬人員</p>
								<div class="form-group col-10">
									<form:select class="form-control form-control-lg rounded-0"
										path="authinfoBean.a_id" required="required">
										<form:options items="${AllAuthLists}" />
									</form:select>
								</div>
								<p
								...
								<p
									class="ms-font-lato ms-font-weight-900 text-center text-black">零件數量</p>
								<div class="form-group col-12 col-md-10">
									<form:input type="text"
										class="form-control form-control-lg rounded-0" id="cbuilddate"
										path="md_pcs" placeholder="BuildDate*" />
								</div>
								<p
									class="ms-font-lato ms-font-weight-900 text-center text-black">維修工時</p>
								<div class="form-group col-12 col-md-9">
									<form:input type="text"
										class="form-control form-control-lg rounded-0"
										id="cenginenumber" path="md_hours" placeholder="EngineNumber*" />
								</div>
							</div>
