...
public class ProductDaoImpl implements ProductDao {
	...
	public void updateStock(int productId, int newQuantity) {
		String hql = "UPDATE BookBean SET stock = :newQuantity WHERE bookId = :pid";
		Session session = factory.getCurrentSession();
		int n = session.createQuery(hql).setParameter("pid", productId).setParameter("newQuantity", newQuantity)
				.executeUpdate();
	}
